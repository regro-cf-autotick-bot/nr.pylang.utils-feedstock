...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nr.pylang.utils-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13604&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nr.pylang.utils-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nr.pylang.utils` can be installed with:

```
conda install nr.pylang.utils
```

It is possible to list all of the versions of `nr.pylang.utils` available on your platform with:
